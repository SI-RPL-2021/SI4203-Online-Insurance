<nav class="border-right text-white position-relative w-100" id="sidebar-wrapper">
  <div class="position-fixed h-100 w-100 bg-primary" style="max-width: 15rem">
    <div class="sidebar-heading font-weight-bolder">Insurance</div>
    <hr class="mt-0">
    <ul class="nav flex-column px-3">
      ...
      <li class="nav-item mb-2">
        <a class="nav-link btn btn-primary text-left font-weight-bold {{ Route::is('warehouse*') ? 'active' : '' }}" href="{{ route('policies') }}">
      ...
      @endif
      <li class="nav-item mb-2">
        <a class="nav-link btn btn-primary text-left font-weight-bold {{ Route::is('suppliers*') ? 'active' : '' }}" href="{{ route('subscriptions') }}">
      ...
      <li class="nav-item mb-2">
        <a class="nav-link btn btn-primary text-left font-weight-bold {{ Route::is('products*') ? 'active' : '' }}" href="{{ route('claims') }}">
